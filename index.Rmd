...
#### Using *quantitative comparisons*

-   A critical feature of extracting patterns from data is using quantitative
...
-   Given the engineers' task, they needed to demonstrate how
    temperature affected o-ring resiliency

-   Instead, they introduced their argument by simply reporting select
    prior launches that experienced o-ring damage without introducing
    their concern that *temperature caused* the o-ring problems as seen
    below in Figure 6
    
-   Note, the cherry-picked comparables were possibly the worst examples they
    could have selected since they were test launches, not SRM launches
